...
class CreateMenuItemUseCaseTest {
    ...
    @BeforeEach
    void setUp() {
        useCase = new CreateMenuItemUseCase(menuItemRepository, restaurantRepository,
        ...
        exampleRequest = new MenuItemRequestDTO("Rice and Beans", "Rice and Beans",
                BigDecimal.valueOf(15.20), true, null, 1L);
    }
    ...
    void execute_success() {
        ...
        when(menuItemRepository.save(any(MenuItem.class))).thenReturn(exampleMenuItem);

        MenuItemDTO result = useCase.execute(exampleRequest);
